    ...
    return (
      <div className="Form">
        ...
        <ul><li>Book A: <ul className="exString">
          ...
          B.2, B.3, B.4, B.5, B.6, B.10,B.11, B.15,B.37, B.38,B.39, 3.1 - 3.10,3.17, 3.20,3.23, 3.24,3.27,3.29, 3.30,3.41, 3.42,3.43, 3.44,4.1, 4.2, 4.3,4.4, 4.6, 4.7, 5.1 - 5.7, 5.13, 5.17, 6.1 - 6.8, 6.15,6.16, 6.19,6.20, 4.8 - 4.18
          </ul>
          </li>
          </ul>
